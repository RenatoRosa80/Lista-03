...
valor_inicial = int(input(" Digite o valor que iniciara a multiplicacao: "))
valor_final = int(input(" Digite o valor que finaliza a multiplicacao: "))
while valor_final < valor_inicial:
        print(" Voce digitou o valor final menor que o inicial! ")
        valor_inicial = int(input(" Digite o valor que iniciara a multiplicacao: "))
        valor_final = int(input(" Digite o valor que finaliza a multiplicacao: "))
